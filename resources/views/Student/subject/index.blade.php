        ...
        <table class="table table-bordered subject-table">
            ...
            <tr>
                    ...
                    <a href="{{URL::to('/quiz/'.$subject->subject_id)}}" class="btn btn-info ">View</a>
                        <a href="{{ URL::to('subject/editSubject/'.$subject->subject_id) }}" class="btn btn-warning ">Edit</a>
                        <a href="{{ URL::to('subject/deleteSubject/'.$subject->subject_id)}}" class="btn btn-danger">Delete</a>
                    </td>
